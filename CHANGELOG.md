...
* further lengthen the "no person" scan from ~0.5s to ~1.5s (raise the timeout to 4.0s to fit it) so a briefly turned-away or occluded face is less likely to be mistaken for absence and lock the screen
